...
interface ButtonProps extends ButtonHTMLAttributes<HTMLButtonElement> {
  variant?: 'primary' | 'secondary' | 'outline' | 'ghost' | 'goldOutline' | 'gold' | 'icon';
  size?: 'sm' | 'md' | 'lg' | 'icon';
...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  function Button(
    ...
    const variantStyles = {
      ...
      gold: 'bg-[#dcc090] text-[#122a26] hover:bg-[#d4b47e] focus:ring-[#dcc090] font-semibold',
    };
    ...
    const variantClass = variant === 'goldOutline' ? goldOutlineClasses : variantStyles[variant as keyof typeof variantStyles];
