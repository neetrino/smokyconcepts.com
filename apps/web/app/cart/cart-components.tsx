      ...
      <div className="md:col-span-2 flex flex-col items-start md:items-center justify-center">
        ...
        <div className="flex items-center justify-center gap-2 w-full md:w-auto">
          <button
            ...
            className="w-9 h-9 flex-shrink-0 rounded-xl border border-gray-300 flex items-center justify-center hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          <input
            ...
            disabled={updatingItems.has(item.id)}
            className="w-20 h-9 text-right border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#dcc090] focus:border-transparent disabled:opacity-50 font-medium pl-2 pr-5"
